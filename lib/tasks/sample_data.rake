...
def create_member_statuses

MemberStatus.create!(:label => "verified")
MemberStatus.create!(:label => "activated")
MemberStatus.create!(:label => "unconfirmed")
MemberStatus.create!(:label => "suspended")
MemberStatus.create!(:label => "deactivated")
